        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AplicationState = table.Column<int>(type: "int", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    DeletedDate = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Applications_Bootcamp_BootcampId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    BootcampsId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    InstructorsId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_BootcampInstructor", x => new { x.BootcampsId, x.InstructorsId });
                    table.ForeignKey(
                        name: "FK_BootcampInstructor_Bootcamp_BootcampsId",
                        column: x => x.BootcampsId,
                        principalTable: "Bootcamp",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BootcampInstructor_Instructors_InstructorsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BootcampInstructor_InstructorsId",
                table: "BootcampInstructor",
